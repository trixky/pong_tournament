      ...
      matchs.fetch({
        ...
        user.fetch({
          ...
          $(".Center").append('<div class="PopUp" id="popup-profil">\
                    ...
                    <img id="profil-image-user" src="' + user.get("url") + '">\
                    <div id="player-stat">\
...
document.body.onkeyup = function (e) {
  if (e.keyCode == 32) {
    ...
    console.log(_channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions);
    console.log("space =========== end");

    for (var i = 0; i < _channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions.length; i++) {
      console.log("on PPPPaaarcours --- start");
      console.log(_channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions[i]);
      console.log(_channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions[i].identifier);
      console.log(JSON.parse(_channels_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.subscriptions[i].identifier).room);
  ...
  user.fetch().then(function (res) {
    if (res["error"] == "banned") {
      ...
      if (view[0] != _BackboneViews_AdminView__WEBPACK_IMPORTED_MODULE_3__["adminContentView"]) {
        if ($(".NavBar").length == 0) _BackboneViews_ConnectedView__WEBPACK_IMPORTED_MODULE_1__["connectedMenu"].render();
...
/******/ });
//# sourceMappingURL=application-ab72faeb06985003beb1.js.map